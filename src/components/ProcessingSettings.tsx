  ...
  return (
    <Card className="h-full bg-gradient-card border-0 rounded-lg shadow-bento hover:shadow-hover transition-smooth">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="space-y-2">
            <label className="text-xs font-medium text-muted-foreground flex items-center gap-2">
              ...
              Keywords
              <span className="ml-auto bg-primary/10 text-primary px-1.5 py-0.5 rounded-full text-xs font-bold">
                {settings.keywords}
              </span>
            </label>
            <Slider
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-muted-foreground flex items-center gap-2">
              ...
              Workers
              <span className="ml-auto bg-accent/10 text-accent px-1.5 py-0.5 rounded-full text-xs font-bold">
                {settings.workers}
              </span>
            </label>
            <Slider
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="space-y-2">
            ...
            <Select value={settings.theme} onValueChange={(value) => onSettingsChange('theme', value)}>
              <SelectTrigger className="h-8 text-xs bg-background/50 border-border rounded-lg focus:border-primary">
                <SelectValue />
              </SelectTrigger>
        ...
        {/* Toggles Section */}
        <div className="space-y-2 p-3 bg-background/30 rounded-lg border border-border/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="flex items-center justify-between p-2 bg-card/50 rounded-lg">
              <div className="space-y-0.5">
                <span className="text-xs font-medium text-foreground">Rename File</span>
            ...
            <div className="flex items-center justify-between p-2 bg-card/50 rounded-lg">
              <div className="space-y-0.5">
                <span className="text-xs font-medium text-foreground">Auto Category</span>
            ...
            <div className="flex items-center justify-between p-2 bg-card/50 rounded-lg">
              <div className="space-y-0.5">
                <span className="text-xs font-medium text-foreground">Auto Foldering</span>
